# Manifold Finance $FOLD Subgraph

> graphql endpoint for FOLD ERC20
...
- [Manifold Finance $FOLD Subgraph](#manifold-finance--fold-subgraph)
  * [Quickstart](#quickstart)
    ...
    + [Get a user's token balance](#get-a-user-s-token-balance)
    + [Time travel query: get token balance at specified block number](#time-travel-query--get-token-balance-at-specified-block-number)
    + [Get a user's balance, and approvals](#get-a-user-s-balance--and-approvals)
    + [Usage](#usage)
  ...
  * [3 Schema](#3-schema)
    ...
    + [3.2 Entities](#32-entities)
      - [Example](#example-7)
    + [3.3 Built-In Types](#33-built-in-types)
      - [3.3.1 GraphQL Built-In Scalars](#331-graphql-built-in-scalars)
      - [3.3.2 Bytes](#332-bytes)
      - [3.3.2 Numbers](#332-numbers)
    + [3.4 Enums](#34-enums)
    + [3.5 Entity Relationships](#35-entity-relationships)
      - [3.5.1 Basics](#351-basics)
      - [Example](#example-8)
      - [Example](#example-9)
      - [3.5.2 Reverse Lookups](#352-reverse-lookups)
      - [Example](#example-10)
  * [License](#license)
...
```graphql
{
  user(id: "0xA0766B65A4f7B1da79a1AF79aC695456eFa28644") {
    balance
  }
}
```
...
{
  user(
    id: "0xA0766B65A4f7B1da79a1AF79aC695456eFa28644",
    block: {number: 13107518}
  ) {
    balance
  }
}
...
```graphql
{
  user(id: "0xA0766B65A4f7B1da79a1AF79aC695456eFa28644") {
    id
    balance
    approvals(where: {owner: "0xA0766B65A4f7B1da79a1AF79aC695456eFa28644"}) {
      id
      count
      value
    }
